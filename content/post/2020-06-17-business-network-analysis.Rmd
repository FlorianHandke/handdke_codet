...
knitr::include_graphics("C:/Users/User/Documents/handdke_codet/static/post/2020-06-17-business-network-analysis_files/1-Spinnennetz.jpg")
```
...
```{r}
pages <- fs::dir_info(path = "C:/Users/User/Documents/handdke_codet",
                      recurse = T) %>% 
  tibble::as_tibble() %>% 
